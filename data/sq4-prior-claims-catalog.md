...
| Jean Faucounau | 1975 (orig. *Revue des Études Anciennes*); expanded book editions 1999 (Éditions L'Harmattan, ISBN 2-7384-7703-8) and 2001 | Proto-Ionic Greek (his own proposed "proto-Ionian" Cycladic/maritime-Aegean people), syllabic, statistical/probabilistic method | Funerary hymn to a figure named Arion, "child of Argos, destroyer of Iasos" (side A, read inward) | **Named criticism added this cycle** — see `logs/2026-09-25-sq4-kaulins-butler-faucounau-verification.md`. Peer-reviewed critical source identified: Yves Duhoux, "How Not to Decipher the Phaistos Disc: A Review Article," *American Journal of Archaeology* 104, no. 3 (2000): 597–600, reviewing Faucounau's 1999 book. Per WebSearch-aggregated summaries (not a full-text read — WebFetch blocked to researchgate.net, academia.edu, and dial.uclouvain.be this cycle): Duhoux argues Faucounau's claimed "30 proofs" do not meet basic methodological rigor, and flags a specific linguistic red flag (Linear A's word for "total," KU-RO, does not match its Linear B counterpart to-so, undercutting cross-script vocabulary assumptions). This is the first catalog row backed by an identified peer-reviewed academic source rather than only Wikipedia's own summary language — reading Duhoux's review directly (AJA is on JSTOR, DOI 10.2307/507232) is this catalog's single highest-value next verification target. |
